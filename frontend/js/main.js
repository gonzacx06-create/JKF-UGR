const API_URL = window.location.origin + '/api';  // Ahora usa la misma URL base
...
async function cargarCharlas() {
  try {
    ...
    document.getElementById('charlas-container').innerHTML = '<p style="color:#d52333;">Error al cargar el cronograma. Intenta de nuevo.</p>';
  }
}
